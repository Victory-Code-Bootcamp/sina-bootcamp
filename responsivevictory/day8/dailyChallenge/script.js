...
// // Example usage:
// let maxString = "Max is learning JavaScript and loves it!";
// checkForJavaScript(maxString);
...
// Combine string
// var combined = favoriteColor + " " + favoriteFood;
// let combined = `this is your combined input ${favoriteColor} ${favoriteFood}`;
// alert (combined.slice());
...
let inPut = "Is JavaScript in";
let outPut = inPut.includes (checkWord);
console.log(outPut); 
